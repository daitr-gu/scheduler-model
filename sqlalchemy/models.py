...
class TempInstances(BASE, NovaBase):
    """Contains temp instances."""
    __tablename__ = 'temp_instances'

    id = Column(Integer, primary_key=True, nullable=False, autoincrement=True)
    started_at = Column(DateTime, nullable=False, default=timeutils.utcnow)
    stopped_at = Column(DateTime, nullable=False, default=timeutils.utcnow)
